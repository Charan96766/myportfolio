...
const experiences = [
  {
    ...
    company: "Voltuswave Technologies Inida Pvt Ltd",
    ...
    responsibilities: [
      "Building expertise in AWS and Linux to enhance cloud computing skills, aligning with modern industry practices.",
      "Collaborating with senior team members to understand best practices in cloud deployment and infrastructure management.",
      "Participating in training and upskilling sessions focused on AWS services and Linux.",
      "Actively exploring the integration of AWS technologies with previous MERN stack knowledge to broaden technical proficiency.",
      "Contributing to the team's knowledge base by researching emerging trends in cloud computing and optimization.",
    ],
  },
  {
